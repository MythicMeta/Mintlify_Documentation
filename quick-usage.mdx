...
<Frame>
    <img src="/images/version-3.3/image-1-4.png"/>
</Frame>
...
<Frame>
    <img src="/images/version-3.3/image-1-5.png"/>
</Frame>

For c2 profiles, toggle the `HTTP` profile. Change the `Callback host` parameter to be where you want the agent to connect to (if you're using redirectors, you specify that here), similarly specify the `Callback port` for where you want the agent to connect to. Click Next.
...
<Frame>
    <img src="/images/version-3.3/image-1-6.png"/>
</Frame>
...
<Frame>
    <img src="/images/version-3.3/image-1-7.png"/>
</Frame>
