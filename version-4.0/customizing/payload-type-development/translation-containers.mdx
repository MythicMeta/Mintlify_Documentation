---
title: "9. Translation Containers"
---
...
For the Go side of things, we instantiate an instance of the translationstructs.TranslationContainer struct with our same three functions. For GoLang though, we have an Initialize function to add this struct as a new definition to track.
...
These examples can be found at the MythicMeta organization on GitHub: [https://github.com/MythicMeta/ExampleContainers/tree/main/Payload\_Type](https://github.com/MythicMeta/ExampleContainers/tree/main/Payload_Type)
...
Just like with Payload Types, a Translation container doesn't have to be a Dockerized instance. To turn any VM into a translation container just follow the general flow at [#turning-a-vm-into-a-mythic-container](/version-4.0/customizing/payload-type-development#turning-a-vm-into-a-mythic-container)
