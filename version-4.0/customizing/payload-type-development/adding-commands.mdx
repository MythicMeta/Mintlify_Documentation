...
<Tabs>
  <Tab title="Python">
    ...
    This new file should match the requirements of the rest of the [commands](/version-4.0/customizing/payload-type-development/adding-commands/commands#what-do-commands-track)
