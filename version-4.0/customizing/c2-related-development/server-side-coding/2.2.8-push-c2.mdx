...
[Previous: Get IOC](/version-4.0/customizing/c2-related-development/server-side-coding/2.2.7-get-ioc) · [Next: Consuming Containers](/version-4.0/customizing/3.-consuming-containers)
