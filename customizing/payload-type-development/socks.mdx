...
See the [C2 Related Development section](/customizing/payload-type-development/create_tasking/agent-side-coding/socks) for more SOCKS specific message details.
