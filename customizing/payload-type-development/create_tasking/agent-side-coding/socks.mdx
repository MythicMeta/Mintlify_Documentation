...
[Previous4. Submitting Responses](/customizing/payload-type-development/create_tasking/agent-side-coding/action-post_response)[Next6. Reverse Port Forward](/customizing/payload-type-development/create_tasking/agent-side-coding/rpfwd)
