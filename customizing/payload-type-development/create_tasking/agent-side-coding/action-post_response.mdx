...
* Each response style is described in [Hooking Features](/customizing/hooking-features). The format described in each of the Hooking features sections replaces the `... response message` piece above
