...
* How [agent messages](/customizing/payload-type-development/create_tasking/agent-side-coding/agent-message-format) are formatted

* How to perform [initial checkins](/customizing/payload-type-development/create_tasking/agent-side-coding/initial-checkin) and do encrypted [key exchanges](/customizing/payload-type-development/create_tasking/agent-side-coding/initial-checkin#encrypted-key-exchange-checkins)

* How to [Get Tasking](/customizing/payload-type-development/create_tasking/agent-side-coding/action_get_tasking)

* How to [Post Responses](/customizing/payload-type-development/create_tasking/agent-side-coding/action-post_response)

* [Uploading](/customizing/hooking-features/action-upload) Files
