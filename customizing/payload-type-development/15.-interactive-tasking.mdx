...
<Frame>
    <img src="/images/version-3.3/image-1-63.png"/>
</Frame>
...
For information on the message format, check out [Interactive Tasking](https://docs.mythic-c2.net/customizing/payload-type-development/create_tasking/agent-side-coding/8.-interactive-tasking).
