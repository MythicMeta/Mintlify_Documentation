---
title: "14. Reverse PortFwd"
---

See the [C2 Related Development section](/customizing/payload-type-development/create_tasking/agent-side-coding/rpfwd) for more RPFWD specific message details.
