...
<Info>All of these fields are part of the `responses` array that can be included in both a `get_tasking` and a `post_response` message.</Info>
...
When we talk about `Hooking Features` in responses array of an agent messages, we're really talking about a specific set of Dictionary key value pairs that have special meaning.
All responses from the agent to the Mythic server already have to be in a structured format. Each of the following sections goes into what their reserved keywords mean, but some simpler ones are:
...
* [Delegates](/customizing/payload-type-development/create_tasking/agent-side-coding/delegates)

* [Socks](/customizing/hooking-features/socks)

* [Rpfwd](/customizing/hooking-features/rpfwd)

* [Interactive](/customizing/hooking-features/interactive-tasking)

* [Edges](/customizing/hooking-features/linking-agents/action-p2p_info)

* [Alerts](/customizing/hooking-features/alerts)

* [Upload](/customizing/hooking-features/action-upload)

* [Download](/customizing/hooking-features/download)

* [Callback Tokens](/customizing/hooking-features/tokens)

* [Tokens](/customizing/hooking-features/tokens)

* [Keylogs](/customizing/hooking-features/keylog)

* [ProcessResponse](/customizing/payload-type-development/process-response)

* [Commands](/customizing/hooking-features/commands)

* [Processes](/customizing/hooking-features/process_list)

* [Artifacts](/customizing/hooking-features/artifacts)

* [Credentials](/customizing/hooking-features/credentials)

* RemovedFiles

* [FileBrowser](/customizing/hooking-features/file-browser)
