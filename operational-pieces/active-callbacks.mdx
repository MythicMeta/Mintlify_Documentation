...
- Expand Callback - This opens up the callback in a separate window where you can either just view that whole callback full screen
- Edit Description - This allows you to edit the description of a callback (as well as the color of the row in the table). To set this back to the default value set this to an empty string
