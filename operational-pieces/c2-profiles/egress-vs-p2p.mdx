...
The [default HTTP](https://docs.mythic-c2.net/operational-pieces/c2-profiles/http) and the [dynamicHTTP](https://docs.mythic-c2.net/operational-pieces/c2-profiles/dynamichttp) profiles are both examples of egress profiles. They talk directly out of the target network. Egress profiles have associated Docker containers that allow you to do the translation between your special sauce c2 profile and the normal RESTful web requests to the main Mythic server. More information on how this works and how to create your own can be found here: [C2 Related Development](https://docs.mythic-c2.net/customizing/c2-related-development).
...
<Frame>
    <img src="/images/version-3.3/image-1-25.png"/>
</Frame>
