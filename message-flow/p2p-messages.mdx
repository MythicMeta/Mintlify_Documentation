...
More information on P2P message communication can be found [here](https://docs.mythic-c2.net/customizing/payload-type-development/create_tasking/agent-side-coding/delegates).

<Frame>
<img src="/images/version-3.3/image-1-36.png"/>
</Frame>
